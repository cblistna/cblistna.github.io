...
const Tags = ["plan", "pin", "recur", "date", "hide", "svc", "news"];
...
const GoogleEvent = mod
  .object({
    ...
    status: mod.enum(["confirmed", "tentative", "cancelled"]).optional(),
...
const Event = mod
  ...
  .readonly();
const EventAdapter = GoogleEvent.transform((e) =>
  Event.parse({
